...
const menuCards = [
  {
    ...
    items: [
      { name: "Пшенная каша с тыквой", label: "ЗАВТРАК" },
  ...
  {
    title: "750 ккал",
    total: "748 ккал 9/45/46 %",
    items: [
      { name: "Бататные оладьи с соусом из клубники", label: "ЗАВТРАК" },
      { name: "Индийский овощной чечевичный суп", label: "ОБЕД" },
      { name: "Чиа пудинг на кокосовом молоке с манго", label: "ОБЕД 2" },
      { name: "Овощное рагу", label: "УЖИН" },
    ],
  },
  {
    title: "День выхода",
